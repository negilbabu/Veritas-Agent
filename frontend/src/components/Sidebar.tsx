...
export default function Sidebar({
  ...
  // Skeleton shimmer rows shown while fetching
  const SkeletonRows = () => (
                  ...
                  return (
                    <div key={session.id} className="group relative mb-0.5">
                      <button
                        ...
                        // Full title shown on hover as native tooltip
                        title={session.title}
                      ...
                      >
                        <div className="flex items-center gap-2 min-w-0">
                          ...
                          {/* truncate cuts mid-word; full title appears on hover via title attr */}
