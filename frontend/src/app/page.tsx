...
//       setUploading(false);
//     }
//     // Note: don't setUploading(false) on success — we're navigating away
//   };
...
//               disabled={isBusy}
//               className="w-full bg-slate-900 border border-slate-800 p-5 rounded-2xl outline-none focus:ring-2 focus:ring-blue-600 transition-all shadow-2xl disabled:opacity-50"
//             />
//             <button
//               onClick={handleSend}
//               disabled={isBusy}
//               className="absolute right-4 top-4 bg-blue-600 p-1.5 rounded-lg disabled:opacity-40 transition-opacity"
//             >
//               ↑
//             </button>
//           </div>
